...
<%@page import="Board.board.BoardDao"%>
...
<script>
	...
	function list(){
		document.list.action="/AkinatorApp/board.do?command=BOARDMAIN";
	...
	function read(param){		
		...
		document.read.action = "/AkinatorApp/board.do?command=READ";		
...
<BODY>
<center><br>
<a href="/AkinatorApp/TeamAkinator/Index.jsp">Akinator#</a>
<jsp:useBean id="dao" class="Board.board.BoardDao"/>
<%!
...
/* 	Vector list = dao.getBoardList(keyField, keyWord); */
	Vector list = (Vector)request.getAttribute("List"); /* List를 뿌리기위해 받는 곳 */
		...
		<table border=0 width=100% cellpadding=2 cellspacing=0>
			...
			<tr>
				...
				<td>
					...
					<% if(dto.getDepth() > 0){%>
					<%System.out.println("depth의 크기"+dto.getDepth()); %>
...
<tr>
	...
	<%if(session.getAttribute("usernum") != null){%>
		<a href="/AkinatorApp/board.do?command=POSTGETBOARD">[글쓰기]</a>
...
<form name="write" method="post" action="/AkinatorApp/board.do?command=POSTGETBOARD">
