        ...
        <div class="flexslider" style="overflow:hidden;">
            ...
            <ul class="slides" style="width: 1400%;cursor:pointer;">
                <li style="margin-bottom: 0;margin-left:0px;padding:0;">
                  ...
                  <%-- <img  width="215" height="215" alt="제품 이미지1"  src="/AkinatorApp/Mokhwan/upload/${dto.productImage}"  onerror="this.src='File/img/noimage.jpg'"></img></a> --%>
                  <input type="image" src="/AkinatorApp/Mokhwan/upload/${dto.productImage}" width="215" height="215" alt="제품 이미지1"/>
                    </form>
