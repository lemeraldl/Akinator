...
public static void gmailPassword(String email, String pass) 
 ...
 private static class SMTPAuthenticator extends javax.mail.Authenticator {
  public PasswordAuthentication getPasswordAuthentication() {
   return new PasswordAuthentication("hta.l3.akinator@gmail.com ", "dkzlspdlxj"); // Google id, pwd, 주의) @gmail.com 은 제외하세요
  }
 }
 ...
 public static void favoritemail(String email, String keyword){
	...
	// session.setAttribute
	  ...
	  try {
	   ...
	   Address fromAddr = new InternetAddress("hta.l3.akinator@gmail.com"); // 보내는 사람의 메일주소
	   msg.setFrom(fromAddr);
	   Address toAddr = new InternetAddress(email);  // 받는 사람의 메일주소
	   msg.addRecipient(Message.RecipientType.TO, toAddr); 
	   msg.setContent(message, "text/plain;charset=KSC5601");
